...
Test: "It should return a word match regard;ess of punctuation."
Code:
...
Test: "It should wrap words that march in 'b' tags but not words that don't."
Code:
const word ="hello";
const text = "hello there";
boldPassage(word, text);
